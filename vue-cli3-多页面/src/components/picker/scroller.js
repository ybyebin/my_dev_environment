...
var Scroller = function (component, content, options) {
    ...
    component.addEventListener(_event.start, self.startFun, false);

    component.addEventListener(_event.move, self.moveFun, false);

    component.addEventListener(_event.end, self.endFun, false);
};
...
var members = {
    ...
    removeListion() {
        var self = this;
        var component = self.__component;
        var _event = self._event;

        component.removeEventListener(_event.start, self.startFun);
        component.removeEventListener(_event.move, self.moveFun);
        component.removeEventListener(_event.end, self.endFun);
    },
