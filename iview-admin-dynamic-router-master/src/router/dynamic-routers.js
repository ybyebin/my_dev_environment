...
/**
 * 需要动态加载的路由
 * 根据路由配置中meta.access里的信息与用户拥有的access数组进行比对，筛选具有权限的路由，加载.
 *
 */
export default [{
  path: '',
  ...
  },
  {
    ...
    children: [{
      ...
      component: () => import ('@/view/pet/cat/Cat.vue')
    }, {
      path: 'dog',
      name: 'Dog',
      meta: {
      ...
      component: () => import ('@/view/pet/dog/Dog.vue')
    }, {
      path: 'pig',
      name: 'Pig',
      meta: {
      ...
      children: [
        {
          ...
          component: () => import ('@/view/pet/pig/Pig.vue')
        },
        {
          path: 'male',
          name: 'Male',
